      ...
      <div className="space-y-4">
        ...
        {renderSection("pricing", `💰 Planos de Preço (${form.pricing_plans.length})`,
          <>
            ...
            <Button variant="outline" size="sm" className="mt-2" onClick={() => set("pricing_plans", [...form.pricing_plans, { id: `plano-${form.pricing_plans.length + 1}`, label: "", description: "", total: 0, service_count: 1, ...recalcPlanDiscounts(0, form.payment_discounts), recommended: false }])}>+ Adicionar plano</Button>
          </>
        )}
