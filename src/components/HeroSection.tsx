  ...
  useEffect(() => {
    ...
    if (titleRef.current) {
      ...
      tl.to(chars, {
        ...
        stagger: 0.03, duration: 0.9, ease: "back.out(1.7)",
      });
      ...
      gsap.to(chars, {
        ...
        yoyo: true, repeat: -1, repeatDelay: 8, delay: 6,
      });
    }
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className="flex justify-center mb-4">
          <svg ref={logoRef} viewBox="0 0 300 120" className="w-40 md:w-56 lg:w-64" style={{ overflow: "visible" }}>
            <text className="logo-letter" x="75" y="95" textAnchor="middle" fontFamily="'Cormorant Garamond', serif" fontSize="110" fontWeight="300" fill="transparent" stroke="hsl(43, 59%, 52%)" strokeWidth="1.5">E</text>
            ...
            <text className="logo-letter" x="225" y="95" textAnchor="middle" fontFamily="'Cormorant Garamond', serif" fontSize="110" fontWeight="300" fill="transparent" stroke="hsl(43, 59%, 52%)" strokeWidth="1.5">G</text>
        ...
        <motion.div
          ...
          className="space-y-1"
        >
          <p className="font-ui text-sm tracking-[0.25em] uppercase text-primary tabular-nums">13 · 03 · 2027</p>
          <p className="font-body text-xs text-muted-foreground/80">Ninho da Roxinha · 18h — 22h · 150 convidados</p>
        </motion.div>
