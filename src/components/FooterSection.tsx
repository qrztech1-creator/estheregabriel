  ...
  useEffect(() => {
    ...
    paths.forEach((path) => {
      ...
      gsap.set(el, {
        ...
        fill: "transparent", stroke: "hsl(43, 59%, 52%)", strokeWidth: 1,
      });
    });
    ...
    <footer className="relative overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(0 0% 3.1%), hsl(0 0% 2%))" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-12 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <img src={logo} alt="Home Music" className="h-16 md:h-20 w-auto opacity-80" />
        </div>

        {/* EG animated initials */}
        <div className="flex justify-center mb-6">
          <svg ref={logoRef} viewBox="0 0 260 100" className="w-28 md:w-36" style={{ overflow: "visible" }}>
            <text className="footer-letter" x="65" y="80" textAnchor="middle" fontFamily="'Cormorant Garamond', serif" fontSize="90" fontWeight="300" fill="transparent" stroke="hsl(43, 59%, 52%)" strokeWidth="1" opacity="0.4">E</text>
            ...
            <text className="footer-letter" x="195" y="80" textAnchor="middle" fontFamily="'Cormorant Garamond', serif" fontSize="90" fontWeight="300" fill="transparent" stroke="hsl(43, 59%, 52%)" strokeWidth="1" opacity="0.4">G</text>
          </svg>
        </div>
        ...
        >
          <p className="font-display text-3xl md:text-4xl text-primary font-light mb-1">Esther & Gabriel</p>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 font-ui text-xs tracking-[0.2em] uppercase text-primary hover:text-foreground transition-colors duration-150 mb-10 hover:scale-105"
          >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10">
            <a href="/playlist/esther-gabriel-2027" className="font-ui text-[10px] tracking-[0.15em] uppercase text-muted-foreground hover:text-primary transition-colors duration-150">Personalizar Repertório</a>
            <a href="https://wa.me/5527999936682?text=Ol%C3%A1!%20Gostaria%20de%20aceitar%20a%20proposta%20musical.%20Podemos%20conversar%3F" target="_blank" rel="noopener noreferrer" className="font-ui text-[10px] tracking-[0.15em] uppercase text-muted-foreground hover:text-primary transition-colors duration-150">Aceitar Proposta</a>
            <a href="https://wa.me/5527999936682?text=Ol%C3%A1!%20Tenho%20algumas%20d%C3%BAvidas%20sobre%20a%20proposta." target="_blank" rel="noopener noreferrer" className="font-ui text-[10px] tracking-[0.15em] uppercase text-muted-foreground hover:text-primary transition-colors duration-150">Tirar Dúvidas</a>
          </div>
